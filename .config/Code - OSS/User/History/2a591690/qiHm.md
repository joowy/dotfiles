...
Teaches the LLM to write `/** */` block doc comments for Rust methods, replacing terse `///` one-liners (`catalog.rs` style). Uses deep body analysis and file-level `// ABOUTME` context to generate accurate, multi-paragraph documentation.
